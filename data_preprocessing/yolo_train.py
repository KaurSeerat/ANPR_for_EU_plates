...
File: yolo_train.py
Description:
Script to train YOLOv8 model for European number plate detection using
Ultralytics framework. Supports logging with Weights & Biases (W&B), saves model
weights, and visualises training metrics. Also includes inference and evaluation on a test dataset.
"""
import os
import wandb
...
project_dir = "./models/yolo-training"
